...
mbnfjkxptbtjmgcrtkhxjvjhjnine83mpnsixfcmxcbnspx";
    ...
    for word in splitted {
        ...
        let n = format!("{}{}", first, last).parse::<u32>();
        match n {
            Err(_) => continue,
            Ok(v) => sum += n.unwrap()
        }
    ...
    */
    ...
    for word in splitted {
        ...
        // let mut firstNum = 100;
        // let mut lastFirstNum = 100;
        // i = 0;
        // for n in numbers {
        //     firstNum = match word.find(n) {
        //         Some(v) => v,
        //         None => 100
        //     };
        //     if firstNum != 100 && lastFirstNum > firstNum {
        //         num = i;
        //         lastFirstNum = firstNum;
        //     }
        //     i += 1;
        // }
        // if lastFirstNum > firstReal {
        //     num = word.chars().nth(firstReal).unwrap().to_digit(10).unwrap() as usize;
        // }



        // let mut lastReal = 100;
        // let mut i = 0;
        // for c in word.chars() {
        //     if c.is_digit(10) {
        //         lastReal = i;
        ...
        // }
        // let mut lastNum = 100;
        // let mut lastLastNum: i32 = -1;
        // let mut num2 = 100;
        // i = 0;
        // for n in numbers {
        //     lastNum = match word.find(n) {
        //         Some(v) => v,
        //         None => 100
        //     };
        //     if lastNum != 100 && lastLastNum < lastNum as i32 {
        //         num2 = i;
        //         lastLastNum = lastNum as i32;
        //     }
        //     i += 1;
        // }
        // if lastLastNum < lastReal as i32 && lastReal != 100 {
        //     num2 = word.chars().nth(lastReal).unwrap().to_digit(10).unwrap() as usize;
        // }
        // println!("num: {} | num2: {}", num, num2);
        let numbers = ["zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine"];
        let num = find_first_in(word, numbers);
        let revNumbers = numbers.map(|n| n.chars().rev().collect::<String>());
        let mut revStrNumbers = ["";10];
        let mut i = 0;
        while i < 10 {
            revStrNumbers[i] = revNumbers[i].as_str();
            i += 1;
        }
        let num2 = find_first_in(word.chars().rev().collect::<String>().as_str(), revStrNumbers);
